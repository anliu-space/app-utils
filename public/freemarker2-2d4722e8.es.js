...
import { c as _defineProperty, r as _objectSpread2, _ as _typeof, b as _createForOfIteratorHelper } from './dayjs-baf73ada.es.js';
...
function createMonarchLanguage(ts, is) {
  var _objectSpread2$1, _cases, _objectSpread3, _tokenizer, _ref;
  ...
  return _ref = {
    ...
    cases: {
      ...
      "\\]": {
        cases: _objectSpread2(_objectSpread2(_objectSpread2({}, is.id === "bracket" ? {
          "$S2==interpolation": {
        ...
        } : {}), {}, (_objectSpread2$1 = {}, _defineProperty(_objectSpread2$1, s("$S1==inParen__id__"), {
          token: "@brackets",
          next: "@pop"
        }), _defineProperty(_objectSpread2$1, "@default", {
          token: "@brackets"
        }), _objectSpread2$1))
      },
      "\\(": {
      ...
      "\\}": {
        cases: _objectSpread2(_objectSpread2({}, is.id === "bracket" ? {} : {
          "$S2==interpolation": {
            token: "@brackets.interpolation",
            next: "@popall"
          }
...
function createMonarchLanguageAuto(is) {
  ...
  return _objectSpread2(_objectSpread2(_objectSpread2(_objectSpread2({}, angle), bracket), auto), {}, {
    unicode: true,
    includeLF: false,
    ...
    tokenizer: _objectSpread2(_objectSpread2(_objectSpread2({}, angle.tokenizer), bracket.tokenizer), auto.tokenizer)
  });
}
...
//# sourceMappingURL=freemarker2-2d4722e8.es.js.map
