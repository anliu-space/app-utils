...
import { m as monaco_editor_core_star } from './index-2f46c4c6.es.js';
import './dayjs-600b7168.es.js';
import './editorSimpleWorker-4169e1e7.es.js';
...
__reExport$1(monaco_editor_core_exports$1, monaco_editor_core_star);
...
var LanguageServiceDefaultsImpl = class {
  ...
  _onDidExtraLibsChange = new monaco_editor_core_exports$1.Emitter();
  _extraLibs;
  _removedExtraLibs;
  _eagerModelSync;
  _compilerOptions;
...
var getTypeScriptWorker$1 = () => {
  return getMode().then((mode) => mode.getTypeScriptWorker());
};
var getJavaScriptWorker$1 = () => {
  return getMode().then((mode) => mode.getJavaScriptWorker());
};
monaco_editor_core_exports$1.languages.typescript = {
  ModuleKind,
  JsxEmit,
  NewLineKind,
  ScriptTarget,
  ...
  typescriptDefaults,
  javascriptDefaults,
  getTypeScriptWorker: getTypeScriptWorker$1,
  getJavaScriptWorker: getJavaScriptWorker$1
};
function getMode() {
  {
    return Promise.resolve().then(function () { return tsMode; });
  }
}
monaco_editor_core_exports$1.languages.onLanguage("typescript", () => {
  return getMode().then((mode) => mode.setupTypeScript(typescriptDefaults));
});
monaco_editor_core_exports$1.languages.onLanguage("javascript", () => {
...
var tsMode = /*#__PURE__*/Object.freeze({
  __proto__: null,
  Adapter: Adapter,
...
//# sourceMappingURL=tsMode-a9edbb5c.es.js.map
