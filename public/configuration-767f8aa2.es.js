 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
var __extends$1 = (self && self.__extends) || (function () {
...
var NullASTNodeImpl = /** @class */ (function (_super) {
    __extends$1(NullASTNodeImpl, _super);
...
var BooleanASTNodeImpl = /** @class */ (function (_super) {
    __extends$1(BooleanASTNodeImpl, _super);
...
var ArrayASTNodeImpl = /** @class */ (function (_super) {
    __extends$1(ArrayASTNodeImpl, _super);
...
var NumberASTNodeImpl = /** @class */ (function (_super) {
    __extends$1(NumberASTNodeImpl, _super);
...
var StringASTNodeImpl = /** @class */ (function (_super) {
    __extends$1(StringASTNodeImpl, _super);
...
var PropertyASTNodeImpl = /** @class */ (function (_super) {
    __extends$1(PropertyASTNodeImpl, _super);
...
var ObjectASTNodeImpl = /** @class */ (function (_super) {
    __extends$1(ObjectASTNodeImpl, _super);
        ...
        if (!this.enumValueMatch && !validationResult.enumValueMatch && this.enumValues && validationResult.enumValues) {
            ...
            for (var _i = 0, _a = this.problems; _i < _a.length; _i++) {
                ...
                if (error.code === ErrorCode.EnumValueMismatch) {
                    error.message = localize$4('enumWarning', 'Value is not accepted. Valid values: {0}.', this.enumValues.map(function (v) { return JSON.stringify(v); }).join(', '));
                }
            }
        }
    };
        ...
        if (Array.isArray(schema.enum)) {
            ...
            if (!enumValueMatch) {
                validationResult.problems.push({
                    ...
                    message: schema.errorMessage || localize$4('enumWarning', 'Value is not accepted. Valid values: {0}.', schema.enum.map(function (v) { return JSON.stringify(v); }).join(', '))
                });
            }
        }
                    ...
                    if (item.type === 'object') {
                        for (var _b = 0, _c = item.properties; _b < _c.length; _b++) {
                            ...
                            if (property.keyNode.value === 'key' && property.valueNode) {
                                ...
                                result_1.push({ name: getNodeValue(property.valueNode), kind: SymbolKind.Function, location: location });
                                limit--;
                                if (limit <= 0) {
                    ...
                    if (item.type === 'object') {
                        for (var _b = 0, _c = item.properties; _b < _c.length; _b++) {
                            ...
                            if (property.keyNode.value === 'key' && property.valueNode) {
                                ...
                                result_2.push({ name: getNodeValue(property.valueNode), kind: SymbolKind.Function, range: range, selectionRange: selectionRange });
                                limit--;
                                if (limit <= 0) {
                                    if (context && context.onResultLimitExceeded) {
                                        context.onResultLimitExceeded(resourceString);
...
export { CompletionItemKind as C, DiagnosticSeverity as D, FoldingRangeKind as F, InsertTextFormat as I, JSONSchemaService as J, Position as P, Range as R, SelectionRange as S, TextEdit as T, URI as U, JSONCompletion as a, JSONHover as b, createScanner as c, JSONDocumentSymbols as d, JSONValidation as e, format$1 as f, TextDocument as g, SymbolKind as h, newJSONDocument as n, parse as p, schemaContributions as s };
//# sourceMappingURL=configuration-767f8aa2.es.js.map
